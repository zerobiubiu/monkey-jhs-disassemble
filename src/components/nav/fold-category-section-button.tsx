 ...
 * 折叠分类按钮——外层 div#foldCategoryBtn 包装内层 a.jhs-toolbar-menu-btn（红色背景、
 * 左外边距、去底边、圆角），含 span 文案占位 + i 图标占位。
 *
 * 保留原 HTML 结构、id（foldCategoryBtn 在外层 div）、class（jhs-toolbar-menu-btn）、
...
export function FoldCategorySectionButton() {
    ...
    return (
        <div id="foldCategoryBtn">
            <a className="jhs-toolbar-menu-btn" style={anchorStyle}>
                <span></span>
                <i style={iconStyle}></i>
            </a>
        </div>
