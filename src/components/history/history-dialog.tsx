 ...
 * allSelectBox/table-container）、类名（jhs-toolbar-menu-btn/a-info/multiple-history-*）、
    ...
    return (
        ...
        >
            ...
            <div id="allSelectBox" style={{ marginTop: '8px', display: 'none' }}>
                <a
                    className="jhs-toolbar-menu-btn multiple-history-deleteBtn"
                    style={{
                ...
                <a
                    className="jhs-toolbar-menu-btn multiple-history-hasWatchBtn"
                    style={{
                ...
                <a
                    className="jhs-toolbar-menu-btn multiple-history-favoriteBtn"
                    style={{
                ...
                <a
                    className="jhs-toolbar-menu-btn multiple-history-filterBtn"
                    style={{
